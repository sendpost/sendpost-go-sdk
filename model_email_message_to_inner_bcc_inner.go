...
// checks if the EmailMessageToInnerBccInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailMessageToInnerBccInner{}
...
// NewEmailMessageToInnerBccInner instantiates a new EmailMessageToInnerBccInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewEmailMessageToInnerBccInner() *EmailMessageToInnerBccInner {
	this := EmailMessageToInnerBccInner{}
	return &this
}

// NewEmailMessageToInnerBccInnerWithDefaults instantiates a new EmailMessageToInnerBccInner object
...
type NullableEmailMessageToInnerBccInner struct {
	value *EmailMessageToInnerBccInner
	isSet bool
}

func (v NullableEmailMessageToInnerBccInner) Get() *EmailMessageToInnerBccInner {
	return v.value
}

func (v *NullableEmailMessageToInnerBccInner) Set(val *EmailMessageToInnerBccInner) {
	v.value = val
	v.isSet = true
}

func (v NullableEmailMessageToInnerBccInner) IsSet() bool {
	return v.isSet
}

func (v *NullableEmailMessageToInnerBccInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmailMessageToInnerBccInner(val *EmailMessageToInnerBccInner) *NullableEmailMessageToInnerBccInner {
	return &NullableEmailMessageToInnerBccInner{value: val, isSet: true}
}
