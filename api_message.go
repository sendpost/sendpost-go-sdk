...
func (r ApiGetMessageByIdRequest) Execute() (*Message, *http.Response, error) {
...
func (a *MessageAPIService) GetMessageByIdExecute(r ApiGetMessageByIdRequest) (*Message, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MessageAPIService.GetMessageById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/account/message/{message_id}"
