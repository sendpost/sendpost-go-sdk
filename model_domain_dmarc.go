...
// checks if the DomainDmarc type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DomainDmarc{}
...
// NewDomainDmarc instantiates a new DomainDmarc object
...
// NewDomainDmarcWithDefaults instantiates a new DomainDmarc object
...
func (v NullableDomainDmarc) Get() *DomainDmarc {
	return v.value
}
...
func NewNullableDomainDmarc(val *DomainDmarc) *NullableDomainDmarc {
	return &NullableDomainDmarc{value: val, isSet: true}
}
