...
// checks if the CreateSuppressionRequestManualInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSuppressionRequestManualInner{}
...
// NewCreateSuppressionRequestManualInner instantiates a new CreateSuppressionRequestManualInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCreateSuppressionRequestManualInner() *CreateSuppressionRequestManualInner {
	this := CreateSuppressionRequestManualInner{}
	return &this
}

// NewCreateSuppressionRequestManualInnerWithDefaults instantiates a new CreateSuppressionRequestManualInner object
...
func (o *CreateSuppressionRequestManualInner) GetEmail() string {
...
func (o *CreateSuppressionRequestManualInner) HasEmail() bool {
	if o != nil && !IsNil(o.Email) {
		return true
	}
...
func (o *CreateSuppressionRequestManualInner) SetEmail(v string) {
	o.Email = &v
}
...
type NullableCreateSuppressionRequestManualInner struct {
	value *CreateSuppressionRequestManualInner
	isSet bool
}

func (v NullableCreateSuppressionRequestManualInner) Get() *CreateSuppressionRequestManualInner {
	return v.value
}

func (v *NullableCreateSuppressionRequestManualInner) Set(val *CreateSuppressionRequestManualInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSuppressionRequestManualInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSuppressionRequestManualInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSuppressionRequestManualInner(val *CreateSuppressionRequestManualInner) *NullableCreateSuppressionRequestManualInner {
	return &NullableCreateSuppressionRequestManualInner{value: val, isSet: true}
}

func (v NullableCreateSuppressionRequestManualInner) MarshalJSON() ([]byte, error) {
