...
// checks if the IPPoolDeleteResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IPPoolDeleteResponse{}
...
// NewIPPoolDeleteResponse instantiates a new IPPoolDeleteResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewIPPoolDeleteResponse() *IPPoolDeleteResponse {
	this := IPPoolDeleteResponse{}
	return &this
}

// NewIPPoolDeleteResponseWithDefaults instantiates a new IPPoolDeleteResponse object
...
type NullableIPPoolDeleteResponse struct {
	value *IPPoolDeleteResponse
	isSet bool
}

func (v NullableIPPoolDeleteResponse) Get() *IPPoolDeleteResponse {
	return v.value
}

func (v *NullableIPPoolDeleteResponse) Set(val *IPPoolDeleteResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableIPPoolDeleteResponse) IsSet() bool {
	return v.isSet
}
...
func NewNullableIPPoolDeleteResponse(val *IPPoolDeleteResponse) *NullableIPPoolDeleteResponse {
	return &NullableIPPoolDeleteResponse{value: val, isSet: true}
}
