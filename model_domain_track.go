...
// checks if the DomainTrack type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DomainTrack{}
...
// NewDomainTrack instantiates a new DomainTrack object
...
// NewDomainTrackWithDefaults instantiates a new DomainTrack object
...
func (v NullableDomainTrack) Get() *DomainTrack {
	return v.value
}
...
func NewNullableDomainTrack(val *DomainTrack) *NullableDomainTrack {
	return &NullableDomainTrack{value: val, isSet: true}
}
