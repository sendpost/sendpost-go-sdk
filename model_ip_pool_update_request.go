...
// checks if the IPPoolUpdateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IPPoolUpdateRequest{}
...
type NullableIPPoolUpdateRequest struct {
	value *IPPoolUpdateRequest
	isSet bool
}

func (v NullableIPPoolUpdateRequest) Get() *IPPoolUpdateRequest {
	return v.value
}

func (v *NullableIPPoolUpdateRequest) Set(val *IPPoolUpdateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableIPPoolUpdateRequest) IsSet() bool {
	return v.isSet
}
...
func NewNullableIPPoolUpdateRequest(val *IPPoolUpdateRequest) *NullableIPPoolUpdateRequest {
	return &NullableIPPoolUpdateRequest{value: val, isSet: true}
}
