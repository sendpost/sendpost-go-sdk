...
*/
func (a *SuppressionAPIService) CreateSuppression(ctx context.Context) ApiCreateSuppressionRequest {
	return ApiCreateSuppressionRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SuppressionAPIService) CreateSuppressionExecute(r ApiCreateSuppressionRequest) ([]Suppression, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SuppressionAPIService.CreateSuppression")
	if err != nil {
	...
	if r.createSuppressionRequest == nil {
		return localVarReturnValue, nil, reportError("createSuppressionRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createSuppressionRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["subAccountAuth"]; ok {
				var key string
				if apiKey.Prefix != "" {
				...
				localVarHeaderParams["X-SubAccount-ApiKey"] = key
			}
		}
	}
...
func (r ApiDeleteSuppressionRequest) Execute() ([]DeleteSuppression200ResponseInner, *http.Response, error) {
...
func (a *SuppressionAPIService) DeleteSuppressionExecute(r ApiDeleteSuppressionRequest) ([]DeleteSuppression200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []DeleteSuppression200ResponseInner
	)
	...
	if r.deleteSuppressionRequest == nil {
		return localVarReturnValue, nil, reportError("deleteSuppressionRequest is required and must be specified")
	}
...
func (r ApiGetSuppressionListRequest) From(from string) ApiGetSuppressionListRequest {
	r.from = &from
	return r
}

// End date for the suppression records (Note: &#x60;from&#x60; should be earlier than &#x60;to&#x60; and the date range should not exceed 60 days) 
func (r ApiGetSuppressionListRequest) To(to string) ApiGetSuppressionListRequest {
	r.to = &to
	return r
}

// Number of records to return per request
func (r ApiGetSuppressionListRequest) Limit(limit int32) ApiGetSuppressionListRequest {
	r.limit = &limit
	return r
}

// Number of initial records to skip
func (r ApiGetSuppressionListRequest) Offset(offset int32) ApiGetSuppressionListRequest {
	r.offset = &offset
	return r
}

// Case-insensitive search against suppression email
func (r ApiGetSuppressionListRequest) Search(search string) ApiGetSuppressionListRequest {
	r.search = &search
	return r
}

// Type of suppression. Valid values: &#x60;hardBounce&#x60;, &#x60;manual&#x60;, &#x60;spamComplaint&#x60;, &#x60;unsubscribe&#x60; 
func (r ApiGetSuppressionListRequest) Type_(type_ string) ApiGetSuppressionListRequest {
	r.type_ = &type_
	return r
}

func (r ApiGetSuppressionListRequest) Execute() ([]Suppression, *http.Response, error) {
	return r.ApiService.GetSuppressionListExecute(r)
}
...
*/
func (a *SuppressionAPIService) GetSuppressionList(ctx context.Context) ApiGetSuppressionListRequest {
	return ApiGetSuppressionListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SuppressionAPIService) GetSuppressionListExecute(r ApiGetSuppressionListRequest) ([]Suppression, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SuppressionAPIService.GetSuppressionList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
