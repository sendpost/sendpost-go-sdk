...
// checks if the ThirdPartySendingProvider type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThirdPartySendingProvider{}
...
func NewThirdPartySendingProvider() *ThirdPartySendingProvider {
	this := ThirdPartySendingProvider{}
	return &this
}
...
type NullableThirdPartySendingProvider struct {
	value *ThirdPartySendingProvider
	isSet bool
}

func (v NullableThirdPartySendingProvider) Get() *ThirdPartySendingProvider {
	return v.value
}

func (v *NullableThirdPartySendingProvider) Set(val *ThirdPartySendingProvider) {
	v.value = val
	v.isSet = true
}

func (v NullableThirdPartySendingProvider) IsSet() bool {
	return v.isSet
}

func (v *NullableThirdPartySendingProvider) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableThirdPartySendingProvider(val *ThirdPartySendingProvider) *NullableThirdPartySendingProvider {
	return &NullableThirdPartySendingProvider{value: val, isSet: true}
}
