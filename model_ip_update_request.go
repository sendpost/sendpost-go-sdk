...
// checks if the IPUpdateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IPUpdateRequest{}
...
type _IPUpdateRequest IPUpdateRequest
...
// GetAutoWarmupEnabledOk returns a tuple with the AutoWarmupEnabled field value
...
func (o *IPUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varIPUpdateRequest := _IPUpdateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIPUpdateRequest)

	if err != nil {
		return err
	}

	*o = IPUpdateRequest(varIPUpdateRequest)

	return err
}

type NullableIPUpdateRequest struct {
	value *IPUpdateRequest
	isSet bool
}

func (v NullableIPUpdateRequest) Get() *IPUpdateRequest {
	return v.value
}

func (v *NullableIPUpdateRequest) Set(val *IPUpdateRequest) {
	v.value = val
	v.isSet = true
}
...
func NewNullableIPUpdateRequest(val *IPUpdateRequest) *NullableIPUpdateRequest {
	return &NullableIPUpdateRequest{value: val, isSet: true}
}
