...
// checks if the MessageTo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MessageTo{}
...
func NewNullableMessageTo(val *MessageTo) *NullableMessageTo {
	return &NullableMessageTo{value: val, isSet: true}
}
