...
// checks if the CreateSuppressionRequestHardBounceInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSuppressionRequestHardBounceInner{}
...
// NewCreateSuppressionRequestHardBounceInner instantiates a new CreateSuppressionRequestHardBounceInner object
...
func NewCreateSuppressionRequestHardBounceInner() *CreateSuppressionRequestHardBounceInner {
	this := CreateSuppressionRequestHardBounceInner{}
	return &this
}

// NewCreateSuppressionRequestHardBounceInnerWithDefaults instantiates a new CreateSuppressionRequestHardBounceInner object
...
func (o *CreateSuppressionRequestHardBounceInner) GetEmail() string {
...
func (o *CreateSuppressionRequestHardBounceInner) GetEmailOk() (*string, bool) {
	if o == nil || IsNil(o.Email) {
		return nil, false
	}
	return o.Email, true
...
func (o *CreateSuppressionRequestHardBounceInner) HasEmail() bool {
	if o != nil && !IsNil(o.Email) {
		return true
	}
...
func (o *CreateSuppressionRequestHardBounceInner) SetEmail(v string) {
	o.Email = &v
}
...
type NullableCreateSuppressionRequestHardBounceInner struct {
	value *CreateSuppressionRequestHardBounceInner
	isSet bool
}

func (v NullableCreateSuppressionRequestHardBounceInner) Get() *CreateSuppressionRequestHardBounceInner {
	return v.value
}

func (v *NullableCreateSuppressionRequestHardBounceInner) Set(val *CreateSuppressionRequestHardBounceInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSuppressionRequestHardBounceInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSuppressionRequestHardBounceInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSuppressionRequestHardBounceInner(val *CreateSuppressionRequestHardBounceInner) *NullableCreateSuppressionRequestHardBounceInner {
	return &NullableCreateSuppressionRequestHardBounceInner{value: val, isSet: true}
}

func (v NullableCreateSuppressionRequestHardBounceInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSuppressionRequestHardBounceInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
