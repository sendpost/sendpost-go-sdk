...
// checks if the EIP type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EIP{}
...
func NewNullableEIP(val *EIP) *NullableEIP {
	return &NullableEIP{value: val, isSet: true}
}
