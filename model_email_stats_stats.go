...
// checks if the EmailStatsStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailStatsStats{}
...
type NullableEmailStatsStats struct {
	value *EmailStatsStats
	isSet bool
}

func (v NullableEmailStatsStats) Get() *EmailStatsStats {
	return v.value
}

func (v *NullableEmailStatsStats) Set(val *EmailStatsStats) {
	v.value = val
	v.isSet = true
}
...
func NewNullableEmailStatsStats(val *EmailStatsStats) *NullableEmailStatsStats {
	return &NullableEmailStatsStats{value: val, isSet: true}
}
