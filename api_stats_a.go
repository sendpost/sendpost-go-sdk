...
func (r ApiGetAccountAggregateStatsRequest) From(from string) ApiGetAccountAggregateStatsRequest {
	r.from = &from
	return r
}

// The end date for retrieving aggregated stats (inclusive). The difference between &#x60;from&#x60; and &#x60;to&#x60; should not exceed 366 days.
func (r ApiGetAccountAggregateStatsRequest) To(to string) ApiGetAccountAggregateStatsRequest {
	r.to = &to
	return r
}

func (r ApiGetAccountAggregateStatsRequest) Execute() (*AggregateStats, *http.Response, error) {
	return r.ApiService.GetAccountAggregateStatsExecute(r)
}
...
func (a *StatsAAPIService) GetAccountAggregateStatsExecute(r ApiGetAccountAggregateStatsRequest) (*AggregateStats, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *AggregateStats
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StatsAAPIService.GetAccountAggregateStats")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/account/stat/aggregate"
	...
	if r.ctx != nil {
		...
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["accountAuth"]; ok {
				var key string
				if apiKey.Prefix != "" {
				...
				localVarHeaderParams["X-Account-ApiKey"] = key
			}
		}
	}
...
func (r ApiGetAccountAggregateStatsByGroupRequest) Group(group string) ApiGetAccountAggregateStatsByGroupRequest {
	r.group = &group
	return r
}

// Date from which stats should be retrieved (should be in the format &#x60;YYYY-MM-DD&#x60;).
func (r ApiGetAccountAggregateStatsByGroupRequest) From(from string) ApiGetAccountAggregateStatsByGroupRequest {
	r.from = &from
	return r
}
...
func (r ApiGetAccountAggregateStatsByGroupRequest) To(to string) ApiGetAccountAggregateStatsByGroupRequest {
	r.to = &to
	return r
}

func (r ApiGetAccountAggregateStatsByGroupRequest) Execute() (*AggregateStat, *http.Response, error) {
	return r.ApiService.GetAccountAggregateStatsByGroupExecute(r)
}
...
func (a *StatsAAPIService) GetAccountAggregateStatsByGroupExecute(r ApiGetAccountAggregateStatsByGroupRequest) (*AggregateStat, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AggregateStat
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StatsAAPIService.GetAccountAggregateStatsByGroup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/account/stat/aggregate/group"
...
func (r ApiGetAccountStatsByGroupRequest) Group(group string) ApiGetAccountStatsByGroupRequest {
	r.group = &group
	return r
}

// Date from which stats should be retrieved (should be in the format &#x60;YYYY-MM-DD&#x60;)
func (r ApiGetAccountStatsByGroupRequest) From(from string) ApiGetAccountStatsByGroupRequest {
	r.from = &from
	return r
}
...
func (r ApiGetAccountStatsByGroupRequest) To(to string) ApiGetAccountStatsByGroupRequest {
	r.to = &to
	return r
}

func (r ApiGetAccountStatsByGroupRequest) Execute() ([]Stat, *http.Response, error) {
	return r.ApiService.GetAccountStatsByGroupExecute(r)
}
...
func (a *StatsAAPIService) GetAccountStatsByGroupExecute(r ApiGetAccountStatsByGroupRequest) ([]Stat, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StatsAAPIService.GetAccountStatsByGroup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/account/stat/group"
...
func (r ApiGetAllAccountStatsRequest) From(from string) ApiGetAllAccountStatsRequest {
	r.from = &from
	return r
}

// The end date for retrieving stats (inclusive). The difference between &#x60;from&#x60; and &#x60;to&#x60; should not exceed 31 days.
func (r ApiGetAllAccountStatsRequest) To(to string) ApiGetAllAccountStatsRequest {
	r.to = &to
	return r
}

func (r ApiGetAllAccountStatsRequest) Execute() ([]AccountStats, *http.Response, error) {
	return r.ApiService.GetAllAccountStatsExecute(r)
}
...
func (a *StatsAAPIService) GetAllAccountStatsExecute(r ApiGetAllAccountStatsRequest) ([]AccountStats, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []AccountStats
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StatsAAPIService.GetAllAccountStats")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/account/stat"
