...
// checks if the IPDeletionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IPDeletionResponse{}
...
type _IPDeletionResponse IPDeletionResponse
...
func NewIPDeletionResponse(id int32, message string) *IPDeletionResponse {
	this := IPDeletionResponse{}
	this.Id = id
	this.Message = message
	return &this
}

// NewIPDeletionResponseWithDefaults instantiates a new IPDeletionResponse object
...
func (o *IPDeletionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varIPDeletionResponse := _IPDeletionResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIPDeletionResponse)

	if err != nil {
		return err
	}

	*o = IPDeletionResponse(varIPDeletionResponse)

	return err
}

type NullableIPDeletionResponse struct {
	value *IPDeletionResponse
	isSet bool
}

func (v NullableIPDeletionResponse) Get() *IPDeletionResponse {
	return v.value
}

func (v *NullableIPDeletionResponse) Set(val *IPDeletionResponse) {
	v.value = val
	v.isSet = true
}
...
func NewNullableIPDeletionResponse(val *IPDeletionResponse) *NullableIPDeletionResponse {
	return &NullableIPDeletionResponse{value: val, isSet: true}
}
