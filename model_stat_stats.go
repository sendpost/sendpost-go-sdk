...
// checks if the StatStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatStats{}
...
func NewNullableStatStats(val *StatStats) *NullableStatStats {
	return &NullableStatStats{value: val, isSet: true}
}
