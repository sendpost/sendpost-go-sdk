...
// checks if the EmailMessageObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailMessageObject{}
...
type NullableEmailMessageObject struct {
	value *EmailMessageObject
	isSet bool
}

func (v NullableEmailMessageObject) Get() *EmailMessageObject {
	return v.value
}

func (v *NullableEmailMessageObject) Set(val *EmailMessageObject) {
	v.value = val
	v.isSet = true
}
...
func NewNullableEmailMessageObject(val *EmailMessageObject) *NullableEmailMessageObject {
	return &NullableEmailMessageObject{value: val, isSet: true}
}
