...
// checks if the CreateSuppressionRequestSpamComplaintInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSuppressionRequestSpamComplaintInner{}
...
// NewCreateSuppressionRequestSpamComplaintInner instantiates a new CreateSuppressionRequestSpamComplaintInner object
...
func NewCreateSuppressionRequestSpamComplaintInner() *CreateSuppressionRequestSpamComplaintInner {
	this := CreateSuppressionRequestSpamComplaintInner{}
	return &this
}

// NewCreateSuppressionRequestSpamComplaintInnerWithDefaults instantiates a new CreateSuppressionRequestSpamComplaintInner object
...
func (o *CreateSuppressionRequestSpamComplaintInner) GetEmail() string {
...
func (o *CreateSuppressionRequestSpamComplaintInner) GetEmailOk() (*string, bool) {
	if o == nil || IsNil(o.Email) {
		return nil, false
	}
	return o.Email, true
...
func (o *CreateSuppressionRequestSpamComplaintInner) HasEmail() bool {
	if o != nil && !IsNil(o.Email) {
		return true
	}
...
func (o *CreateSuppressionRequestSpamComplaintInner) SetEmail(v string) {
	o.Email = &v
}

func (o CreateSuppressionRequestSpamComplaintInner) MarshalJSON() ([]byte, error) {
...
type NullableCreateSuppressionRequestSpamComplaintInner struct {
	value *CreateSuppressionRequestSpamComplaintInner
	isSet bool
}

func (v NullableCreateSuppressionRequestSpamComplaintInner) Get() *CreateSuppressionRequestSpamComplaintInner {
	return v.value
}

func (v *NullableCreateSuppressionRequestSpamComplaintInner) Set(val *CreateSuppressionRequestSpamComplaintInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSuppressionRequestSpamComplaintInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSuppressionRequestSpamComplaintInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSuppressionRequestSpamComplaintInner(val *CreateSuppressionRequestSpamComplaintInner) *NullableCreateSuppressionRequestSpamComplaintInner {
	return &NullableCreateSuppressionRequestSpamComplaintInner{value: val, isSet: true}
}

func (v NullableCreateSuppressionRequestSpamComplaintInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSuppressionRequestSpamComplaintInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
