...
// checks if the DomainReturnPath type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DomainReturnPath{}
...
// NewDomainReturnPath instantiates a new DomainReturnPath object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDomainReturnPath() *DomainReturnPath {
	this := DomainReturnPath{}
	return &this
}

// NewDomainReturnPathWithDefaults instantiates a new DomainReturnPath object
...
type NullableDomainReturnPath struct {
	value *DomainReturnPath
	isSet bool
}

func (v NullableDomainReturnPath) Get() *DomainReturnPath {
	return v.value
}

func (v *NullableDomainReturnPath) Set(val *DomainReturnPath) {
	v.value = val
	v.isSet = true
}
...
func NewNullableDomainReturnPath(val *DomainReturnPath) *NullableDomainReturnPath {
	return &NullableDomainReturnPath{value: val, isSet: true}
}
