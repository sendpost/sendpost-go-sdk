...
func (r ApiCreateSubAccountRequest) Execute() (*SubAccount, *http.Response, error) {
...
*/
func (a *SubAccountAPIService) CreateSubAccount(ctx context.Context) ApiCreateSubAccountRequest {
	return ApiCreateSubAccountRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SubAccountAPIService) CreateSubAccountExecute(r ApiCreateSubAccountRequest) (*SubAccount, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubAccountAPIService.CreateSubAccount")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/account/subaccount/"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createSubAccountRequest == nil {
		return localVarReturnValue, nil, reportError("createSubAccountRequest is required and must be specified")
	}
...
func (r ApiDeleteSubAccountRequest) Execute() (*DeleteSubAccountResponse, *http.Response, error) {
...
func (a *SubAccountAPIService) DeleteSubAccountExecute(r ApiDeleteSubAccountRequest) (*DeleteSubAccountResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DeleteSubAccountResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubAccountAPIService.DeleteSubAccount")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/account/subaccount/{subaccount_id}"
...
func (r ApiGetAllSubAccountsRequest) Limit(limit int32) ApiGetAllSubAccountsRequest {
	r.limit = &limit
	return r
}

// Number of initial records to skip.
func (r ApiGetAllSubAccountsRequest) Offset(offset int32) ApiGetAllSubAccountsRequest {
	r.offset = &offset
	return r
}

// Case-insensitive search against the sub-account name.
func (r ApiGetAllSubAccountsRequest) Search(search string) ApiGetAllSubAccountsRequest {
	r.search = &search
	return r
}

func (r ApiGetAllSubAccountsRequest) Execute() ([]SubAccount, *http.Response, error) {
	return r.ApiService.GetAllSubAccountsExecute(r)
}
...
*/
func (a *SubAccountAPIService) GetAllSubAccounts(ctx context.Context) ApiGetAllSubAccountsRequest {
	return ApiGetAllSubAccountsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SubAccountAPIService) GetAllSubAccountsExecute(r ApiGetAllSubAccountsRequest) ([]SubAccount, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubAccountAPIService.GetAllSubAccounts")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetSubAccountRequest) Execute() (*SubAccount, *http.Response, error) {
...
func (a *SubAccountAPIService) GetSubAccountExecute(r ApiGetSubAccountRequest) (*SubAccount, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubAccountAPIService.GetSubAccount")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateSubAccountRequest) UpdateSubAccount(updateSubAccount UpdateSubAccount) ApiUpdateSubAccountRequest {
	r.updateSubAccount = &updateSubAccount
	return r
}

func (r ApiUpdateSubAccountRequest) Execute() (*SubAccount, *http.Response, error) {
...
func (a *SubAccountAPIService) UpdateSubAccountExecute(r ApiUpdateSubAccountRequest) (*SubAccount, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubAccountAPIService.UpdateSubAccount")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateSubAccount == nil {
		return localVarReturnValue, nil, reportError("updateSubAccount is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateSubAccount
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["accountAuth"]; ok {
