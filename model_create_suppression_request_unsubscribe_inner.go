...
// checks if the CreateSuppressionRequestUnsubscribeInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSuppressionRequestUnsubscribeInner{}
...
// NewCreateSuppressionRequestUnsubscribeInner instantiates a new CreateSuppressionRequestUnsubscribeInner object
...
func NewCreateSuppressionRequestUnsubscribeInner() *CreateSuppressionRequestUnsubscribeInner {
	this := CreateSuppressionRequestUnsubscribeInner{}
	return &this
}

// NewCreateSuppressionRequestUnsubscribeInnerWithDefaults instantiates a new CreateSuppressionRequestUnsubscribeInner object
...
func (o *CreateSuppressionRequestUnsubscribeInner) GetEmail() string {
...
func (o *CreateSuppressionRequestUnsubscribeInner) GetEmailOk() (*string, bool) {
	if o == nil || IsNil(o.Email) {
		return nil, false
	}
	return o.Email, true
...
func (o *CreateSuppressionRequestUnsubscribeInner) HasEmail() bool {
	if o != nil && !IsNil(o.Email) {
		return true
	}
...
func (o *CreateSuppressionRequestUnsubscribeInner) SetEmail(v string) {
	o.Email = &v
}

func (o CreateSuppressionRequestUnsubscribeInner) MarshalJSON() ([]byte, error) {
...
type NullableCreateSuppressionRequestUnsubscribeInner struct {
	value *CreateSuppressionRequestUnsubscribeInner
	isSet bool
}

func (v NullableCreateSuppressionRequestUnsubscribeInner) Get() *CreateSuppressionRequestUnsubscribeInner {
	return v.value
}

func (v *NullableCreateSuppressionRequestUnsubscribeInner) Set(val *CreateSuppressionRequestUnsubscribeInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSuppressionRequestUnsubscribeInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSuppressionRequestUnsubscribeInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSuppressionRequestUnsubscribeInner(val *CreateSuppressionRequestUnsubscribeInner) *NullableCreateSuppressionRequestUnsubscribeInner {
	return &NullableCreateSuppressionRequestUnsubscribeInner{value: val, isSet: true}
}

func (v NullableCreateSuppressionRequestUnsubscribeInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSuppressionRequestUnsubscribeInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
