...
*/
func (a *IPPoolsAPIService) CreateIPPool(ctx context.Context) ApiCreateIPPoolRequest {
	return ApiCreateIPPoolRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *IPPoolsAPIService) CreateIPPoolExecute(r ApiCreateIPPoolRequest) (*IPPool, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPPoolsAPIService.CreateIPPool")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/account/ippool"
...
func (r ApiDeleteIPPoolRequest) Execute() (*IPPoolDeleteResponse, *http.Response, error) {
...
func (a *IPPoolsAPIService) DeleteIPPoolExecute(r ApiDeleteIPPoolRequest) (*IPPoolDeleteResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPPoolDeleteResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPPoolsAPIService.DeleteIPPool")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/account/ippool/{ippool_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"ippool_id"+"}", url.PathEscape(parameterValueToString(r.ippoolId, "ippoolId")), -1)
...
func (r ApiGetAllIPPoolsRequest) Limit(limit int32) ApiGetAllIPPoolsRequest {
	r.limit = &limit
	return r
}

// Number of initial records to skip
func (r ApiGetAllIPPoolsRequest) Offset(offset int32) ApiGetAllIPPoolsRequest {
	r.offset = &offset
	return r
}

// Case insensitive search against IPPool name
func (r ApiGetAllIPPoolsRequest) Search(search string) ApiGetAllIPPoolsRequest {
	r.search = &search
	return r
}

func (r ApiGetAllIPPoolsRequest) Execute() ([]IPPool, *http.Response, error) {
	return r.ApiService.GetAllIPPoolsExecute(r)
}
...
*/
func (a *IPPoolsAPIService) GetAllIPPools(ctx context.Context) ApiGetAllIPPoolsRequest {
	return ApiGetAllIPPoolsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *IPPoolsAPIService) GetAllIPPoolsExecute(r ApiGetAllIPPoolsRequest) ([]IPPool, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPPoolsAPIService.GetAllIPPools")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetIPPoolByIdRequest) Execute() (*IPPool, *http.Response, error) {
	return r.ApiService.GetIPPoolByIdExecute(r)
}
...
func (a *IPPoolsAPIService) GetIPPoolByIdExecute(r ApiGetIPPoolByIdRequest) (*IPPool, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPPoolsAPIService.GetIPPoolById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateIPPoolRequest) IPPoolUpdateRequest(iPPoolUpdateRequest IPPoolUpdateRequest) ApiUpdateIPPoolRequest {
	r.iPPoolUpdateRequest = &iPPoolUpdateRequest
	return r
}
...
func (a *IPPoolsAPIService) UpdateIPPoolExecute(r ApiUpdateIPPoolRequest) (*IPPool, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPPoolsAPIService.UpdateIPPool")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.iPPoolUpdateRequest == nil {
		return localVarReturnValue, nil, reportError("iPPoolUpdateRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.iPPoolUpdateRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
