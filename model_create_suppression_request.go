...
func (o *CreateSuppressionRequest) GetHardBounce() []CreateSuppressionRequestHardBounceInner {
	if o == nil || IsNil(o.HardBounce) {
		var ret []CreateSuppressionRequestHardBounceInner
		return ret
	}
	return o.HardBounce
}
...
func (o *CreateSuppressionRequest) GetManual() []CreateSuppressionRequestManualInner {
	if o == nil || IsNil(o.Manual) {
		var ret []CreateSuppressionRequestManualInner
		return ret
	}
	return o.Manual
}
...
func (o *CreateSuppressionRequest) GetUnsubscribe() []CreateSuppressionRequestUnsubscribeInner {
	if o == nil || IsNil(o.Unsubscribe) {
		var ret []CreateSuppressionRequestUnsubscribeInner
		return ret
	}
...
func (o *CreateSuppressionRequest) GetSpamComplaint() []CreateSuppressionRequestSpamComplaintInner {
	if o == nil || IsNil(o.SpamComplaint) {
		var ret []CreateSuppressionRequestSpamComplaintInner
		return ret
	}
