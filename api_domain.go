...
func (r ApiGetAllDomainsRequest) Limit(limit int32) ApiGetAllDomainsRequest {
	r.limit = &limit
	return r
}

// Number of initial records to skip
func (r ApiGetAllDomainsRequest) Offset(offset int32) ApiGetAllDomainsRequest {
	r.offset = &offset
	return r
}

// Case insensitive search against domain names
func (r ApiGetAllDomainsRequest) Search(search string) ApiGetAllDomainsRequest {
	r.search = &search
	return r
}
...
*/
func (a *DomainAPIService) GetAllDomains(ctx context.Context) ApiGetAllDomainsRequest {
	return ApiGetAllDomainsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DomainAPIService) GetAllDomainsExecute(r ApiGetAllDomainsRequest) ([]Domain, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DomainAPIService.GetAllDomains")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/subaccount/domain"
...
func (r ApiSubaccountDomainDomainIdDeleteRequest) Execute() (*DeleteResponse, *http.Response, error) {
	return r.ApiService.SubaccountDomainDomainIdDeleteExecute(r)
}
...
func (a *DomainAPIService) SubaccountDomainDomainIdDeleteExecute(r ApiSubaccountDomainDomainIdDeleteRequest) (*DeleteResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DomainAPIService.SubaccountDomainDomainIdDelete")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/subaccount/domain/{domain_id}"
...
func (r ApiSubaccountDomainDomainIdGetRequest) Execute() (*Domain, *http.Response, error) {
	return r.ApiService.SubaccountDomainDomainIdGetExecute(r)
}
...
func (a *DomainAPIService) SubaccountDomainDomainIdGetExecute(r ApiSubaccountDomainDomainIdGetRequest) (*Domain, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DomainAPIService.SubaccountDomainDomainIdGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiSubaccountDomainPostRequest) Execute() (*Domain, *http.Response, error) {
	return r.ApiService.SubaccountDomainPostExecute(r)
}
...
func (a *DomainAPIService) SubaccountDomainPostExecute(r ApiSubaccountDomainPostRequest) (*Domain, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DomainAPIService.SubaccountDomainPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
