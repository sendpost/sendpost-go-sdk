...
// checks if the EmailMessageReplyTo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailMessageReplyTo{}
...
// NewEmailMessageReplyTo instantiates a new EmailMessageReplyTo object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewEmailMessageReplyTo() *EmailMessageReplyTo {
	this := EmailMessageReplyTo{}
	return &this
}

// NewEmailMessageReplyToWithDefaults instantiates a new EmailMessageReplyTo object
...
func (v NullableEmailMessageReplyTo) Get() *EmailMessageReplyTo {
	return v.value
}

func (v *NullableEmailMessageReplyTo) Set(val *EmailMessageReplyTo) {
	v.value = val
	v.isSet = true
}

func (v NullableEmailMessageReplyTo) IsSet() bool {
	return v.isSet
}
...
func NewNullableEmailMessageReplyTo(val *EmailMessageReplyTo) *NullableEmailMessageReplyTo {
	return &NullableEmailMessageReplyTo{value: val, isSet: true}
}
