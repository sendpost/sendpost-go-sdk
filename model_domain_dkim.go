...
// checks if the DomainDkim type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DomainDkim{}
...
// NewDomainDkim instantiates a new DomainDkim object
...
// NewDomainDkimWithDefaults instantiates a new DomainDkim object
...
func NewNullableDomainDkim(val *DomainDkim) *NullableDomainDkim {
	return &NullableDomainDkim{value: val, isSet: true}
}
