...
func (a *WebhookAPIService) CreateWebhookExecute(r ApiCreateWebhookRequest) (*Webhook, *http.Response, error) {
	...
	localVarPath := localBasePath + "/account/webhook"
...
func (a *WebhookAPIService) DeleteWebhookExecute(r ApiDeleteWebhookRequest) (*DeleteWebhookResponse, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/account/webhook/{webhook_id}"
...
func (r ApiGetAllWebhooksRequest) Limit(limit int32) ApiGetAllWebhooksRequest {
	r.limit = &limit
	return r
}

// Number of initial records to skip.
func (r ApiGetAllWebhooksRequest) Offset(offset int32) ApiGetAllWebhooksRequest {
	r.offset = &offset
	return r
}

// Case insensitive search against webhook URL.
func (r ApiGetAllWebhooksRequest) Search(search string) ApiGetAllWebhooksRequest {
	r.search = &search
	return r
}
