...
// checks if the EmailMessageFrom type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailMessageFrom{}
...
// NewEmailMessageFrom instantiates a new EmailMessageFrom object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewEmailMessageFrom() *EmailMessageFrom {
	this := EmailMessageFrom{}
	return &this
}

// NewEmailMessageFromWithDefaults instantiates a new EmailMessageFrom object
...
type NullableEmailMessageFrom struct {
	value *EmailMessageFrom
	isSet bool
}

func (v NullableEmailMessageFrom) Get() *EmailMessageFrom {
	return v.value
}

func (v *NullableEmailMessageFrom) Set(val *EmailMessageFrom) {
	v.value = val
	v.isSet = true
}
...
func NewNullableEmailMessageFrom(val *EmailMessageFrom) *NullableEmailMessageFrom {
	return &NullableEmailMessageFrom{value: val, isSet: true}
}
