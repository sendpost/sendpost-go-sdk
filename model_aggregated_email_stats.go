...
// checks if the AggregatedEmailStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AggregatedEmailStats{}
...
type NullableAggregatedEmailStats struct {
	value *AggregatedEmailStats
	isSet bool
}

func (v NullableAggregatedEmailStats) Get() *AggregatedEmailStats {
	return v.value
}

func (v *NullableAggregatedEmailStats) Set(val *AggregatedEmailStats) {
	v.value = val
	v.isSet = true
}

func (v NullableAggregatedEmailStats) IsSet() bool {
	return v.isSet
}
...
func NewNullableAggregatedEmailStats(val *AggregatedEmailStats) *NullableAggregatedEmailStats {
	return &NullableAggregatedEmailStats{value: val, isSet: true}
}
