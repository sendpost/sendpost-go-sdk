...
// checks if the DomainGpt type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DomainGpt{}
...
// NewDomainGpt instantiates a new DomainGpt object
...
// NewDomainGptWithDefaults instantiates a new DomainGpt object
...
func NewNullableDomainGpt(val *DomainGpt) *NullableDomainGpt {
	return &NullableDomainGpt{value: val, isSet: true}
}
