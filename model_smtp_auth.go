...
// checks if the SMTPAuth type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SMTPAuth{}
...
func NewNullableSMTPAuth(val *SMTPAuth) *NullableSMTPAuth {
	return &NullableSMTPAuth{value: val, isSet: true}
}
