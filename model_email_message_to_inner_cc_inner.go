...
// checks if the EmailMessageToInnerCcInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailMessageToInnerCcInner{}
...
// NewEmailMessageToInnerCcInner instantiates a new EmailMessageToInnerCcInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewEmailMessageToInnerCcInner() *EmailMessageToInnerCcInner {
	this := EmailMessageToInnerCcInner{}
	return &this
}

// NewEmailMessageToInnerCcInnerWithDefaults instantiates a new EmailMessageToInnerCcInner object
...
type NullableEmailMessageToInnerCcInner struct {
	value *EmailMessageToInnerCcInner
	isSet bool
}

func (v NullableEmailMessageToInnerCcInner) Get() *EmailMessageToInnerCcInner {
	return v.value
}

func (v *NullableEmailMessageToInnerCcInner) Set(val *EmailMessageToInnerCcInner) {
	v.value = val
	v.isSet = true
}

func (v NullableEmailMessageToInnerCcInner) IsSet() bool {
	return v.isSet
}

func (v *NullableEmailMessageToInnerCcInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmailMessageToInnerCcInner(val *EmailMessageToInnerCcInner) *NullableEmailMessageToInnerCcInner {
	return &NullableEmailMessageToInnerCcInner{value: val, isSet: true}
}
