...
// checks if the EmailMessageToInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailMessageToInner{}
...
func (o *EmailMessageToInner) GetCc() []EmailMessageToInnerCcInner {
	if o == nil || IsNil(o.Cc) {
		var ret []EmailMessageToInnerCcInner
		return ret
	}
	return o.Cc
}
...
func (o *EmailMessageToInner) GetBcc() []EmailMessageToInnerBccInner {
	if o == nil || IsNil(o.Bcc) {
		var ret []EmailMessageToInnerBccInner
		return ret
	}
	return o.Bcc
}
...
type NullableEmailMessageToInner struct {
	value *EmailMessageToInner
	isSet bool
}

func (v NullableEmailMessageToInner) Get() *EmailMessageToInner {
	return v.value
}

func (v *NullableEmailMessageToInner) Set(val *EmailMessageToInner) {
	v.value = val
	v.isSet = true
}

func (v NullableEmailMessageToInner) IsSet() bool {
	return v.isSet
}
...
func NewNullableEmailMessageToInner(val *EmailMessageToInner) *NullableEmailMessageToInner {
	return &NullableEmailMessageToInner{value: val, isSet: true}
}
