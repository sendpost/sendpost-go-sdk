...
// checks if the AggregateStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AggregateStats{}
...
func (v NullableAggregateStats) Get() *AggregateStats {
	return v.value
}

func (v *NullableAggregateStats) Set(val *AggregateStats) {
	v.value = val
	v.isSet = true
}
...
func NewNullableAggregateStats(val *AggregateStats) *NullableAggregateStats {
	return &NullableAggregateStats{value: val, isSet: true}
}
