...
// checks if the AggregateStat type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AggregateStat{}
...
func (v NullableAggregateStat) Get() *AggregateStat {
	return v.value
}
...
func NewNullableAggregateStat(val *AggregateStat) *NullableAggregateStat {
	return &NullableAggregateStat{value: val, isSet: true}
}
