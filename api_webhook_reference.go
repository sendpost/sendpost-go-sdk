...
func (r ApiSendPostWebhooksPostRequest) WebhookObject(webhookObject WebhookObject) ApiSendPostWebhooksPostRequest {
	r.webhookObject = &webhookObject
	return r
}

func (r ApiSendPostWebhooksPostRequest) Execute() (*http.Response, error) {
	return r.ApiService.SendPostWebhooksPostExecute(r)
}
...
*/
func (a *WebhookReferenceAPIService) SendPostWebhooksPost(ctx context.Context) ApiSendPostWebhooksPostRequest {
	return ApiSendPostWebhooksPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WebhookReferenceAPIService) SendPostWebhooksPostExecute(r ApiSendPostWebhooksPostRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhookReferenceAPIService.SendPostWebhooksPost")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/SendPostWebhooks"
	...
	// body params
	localVarPostBody = r.webhookObject
