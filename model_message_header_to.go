...
// checks if the MessageHeaderTo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MessageHeaderTo{}
...
type NullableMessageHeaderTo struct {
	value *MessageHeaderTo
	isSet bool
}

func (v NullableMessageHeaderTo) Get() *MessageHeaderTo {
	return v.value
}

func (v *NullableMessageHeaderTo) Set(val *MessageHeaderTo) {
	v.value = val
	v.isSet = true
}
...
func NewNullableMessageHeaderTo(val *MessageHeaderTo) *NullableMessageHeaderTo {
	return &NullableMessageHeaderTo{value: val, isSet: true}
}
