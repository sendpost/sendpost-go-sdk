...
// checks if the AccountStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountStats{}
...
func (v NullableAccountStats) Get() *AccountStats {
	return v.value
}
...
func NewNullableAccountStats(val *AccountStats) *NullableAccountStats {
	return &NullableAccountStats{value: val, isSet: true}
}
