...
func (r ApiAllocateNewIpRequest) Execute() (*IP, *http.Response, error) {
	return r.ApiService.AllocateNewIpExecute(r)
}
...
func (a *IPAPIService) AllocateNewIpExecute(r ApiAllocateNewIpRequest) (*IP, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPAPIService.AllocateNewIp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/account/ip/allocate"
...
func (r ApiDeleteIpRequest) Execute() (*IPDeletionResponse, *http.Response, error) {
...
func (a *IPAPIService) DeleteIpExecute(r ApiDeleteIpRequest) (*IPDeletionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPDeletionResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPAPIService.DeleteIp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/account/ip/{ip_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"ip_id"+"}", url.PathEscape(parameterValueToString(r.ipId, "ipId")), -1)
...
func (r ApiGetAllIpsRequest) Limit(limit int32) ApiGetAllIpsRequest {
	r.limit = &limit
	return r
}

// Number of initial records to skip
func (r ApiGetAllIpsRequest) Offset(offset int32) ApiGetAllIpsRequest {
	r.offset = &offset
	return r
}

// Case insensitive search against IP&#39;s public IP address
func (r ApiGetAllIpsRequest) Search(search string) ApiGetAllIpsRequest {
	r.search = &search
	return r
}
...
func (a *IPAPIService) GetAllIpsExecute(r ApiGetAllIpsRequest) ([]IP, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPAPIService.GetAllIps")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/account/ip/"
...
func (r ApiGetSpecificIpRequest) Execute() (*IP, *http.Response, error) {
	return r.ApiService.GetSpecificIpExecute(r)
}
...
func (a *IPAPIService) GetSpecificIpExecute(r ApiGetSpecificIpRequest) (*IP, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPAPIService.GetSpecificIp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *IPAPIService) UpdateIpExecute(r ApiUpdateIpRequest) (*IP, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPAPIService.UpdateIp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.iPUpdateRequest == nil {
		return localVarReturnValue, nil, reportError("iPUpdateRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.iPUpdateRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["accountAuth"]; ok {
