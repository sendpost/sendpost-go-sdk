...
// checks if the DeleteSuppression200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteSuppression200ResponseInner{}
...
func NewDeleteSuppression200ResponseInner() *DeleteSuppression200ResponseInner {
	this := DeleteSuppression200ResponseInner{}
	return &this
}
...
type NullableDeleteSuppression200ResponseInner struct {
	value *DeleteSuppression200ResponseInner
	isSet bool
}

func (v NullableDeleteSuppression200ResponseInner) Get() *DeleteSuppression200ResponseInner {
	return v.value
}

func (v *NullableDeleteSuppression200ResponseInner) Set(val *DeleteSuppression200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteSuppression200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteSuppression200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteSuppression200ResponseInner(val *DeleteSuppression200ResponseInner) *NullableDeleteSuppression200ResponseInner {
	return &NullableDeleteSuppression200ResponseInner{value: val, isSet: true}
}

func (v NullableDeleteSuppression200ResponseInner) MarshalJSON() ([]byte, error) {
