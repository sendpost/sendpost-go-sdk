...
func (o *IPPool) GetShouldOverflow() bool {
	if o == nil || IsNil(o.ShouldOverflow) {
		var ret bool
		return ret
	}
	return *o.ShouldOverflow
}

// GetShouldOverflowOk returns a tuple with the ShouldOverflow field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IPPool) GetShouldOverflowOk() (*bool, bool) {
	if o == nil || IsNil(o.ShouldOverflow) {
		return nil, false
	}
	return o.ShouldOverflow, true
}
