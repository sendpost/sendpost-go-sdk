...
// checks if the DeleteSubAccountResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteSubAccountResponse{}
...
type NullableDeleteSubAccountResponse struct {
	value *DeleteSubAccountResponse
	isSet bool
}

func (v NullableDeleteSubAccountResponse) Get() *DeleteSubAccountResponse {
	return v.value
}

func (v *NullableDeleteSubAccountResponse) Set(val *DeleteSubAccountResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteSubAccountResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteSubAccountResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteSubAccountResponse(val *DeleteSubAccountResponse) *NullableDeleteSubAccountResponse {
	return &NullableDeleteSubAccountResponse{value: val, isSet: true}
}
